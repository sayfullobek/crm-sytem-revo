...
import it.revo.revoservice.security.JwtErrors;
import it.revo.revoservice.security.JwtTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/api/auth/**", "/api/course/**", "/api/teacherAndPupil/**", "/api/group/**", "/api/attachment/**", "/api/whereGo/**")
                .permitAll()
